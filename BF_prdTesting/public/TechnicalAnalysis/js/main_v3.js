...
var technicalAnalysisVue = new Vue({
	...
	data() {
		return {
			...
			techAnalyInfo: {},
			rankedImgPath: [
				'https://img-mobile.bbyou.net/promote/lp295/_v2_js_css/images/ranking_icon1.png',
				'https://img-mobile.bbyou.net/promote/lp295/_v2_js_css/images/ranking_icon2.png',
				'https://img-mobile.bbyou.net/promote/lp295/_v2_js_css/images/ranking_icon3.png',
				'https://img-mobile.bbyou.net/promote/lp295/_v2_js_css/images/ranking_icon4.png',
				'https://img-mobile.bbyou.net/promote/lp295/_v2_js_css/images/ranking_icon5.png'
			],
			rankedButtonPath: 'https://img-mobile.bbyou.net/promote/lp295/_v2_js_css/images/r_btn.png',
	...
	methods: {
			...
			try {
				if (res.data.indexOf('p(')==0){//ProductSubscription
					...
					if (msgCode === 'LastPrice') {
						...
						//SORT
						this.rankedIds = [573013,573014,573015];
						//console.log(this.selectedProductIds);
		...
		gaPush(content1,content2){
			gtag.push(['_trackEvent', $GA_NAME, content1, content2, 1, true]);
		},
		lpToH5PageChecking(urlPath) {
			toH5SubPage(urlPath);
			gtag.push(['_trackEvent', $GA_NAME, urlPath, 'content_ti', 1, true]);
		},
