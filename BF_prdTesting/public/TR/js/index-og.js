(function() {
	...
	function init() {
		...
		getKline(function(list) {
			...
			console.log('getKline2: ', klineDataList)
	...
	function mountedData() {
		...
		$('.sellBtn')
			...
			.attr('href', origin + '/JW666key/order/' + productId + '?direction=sell&utm_source='+utm_source+'&utm_medium='+utm_medium+'&utm_term='+utm_term+'&utm_campaign='+utm_campaign+'&utm_content='+utm_content+'&openbrowser=false&experience=true')
		...
		$('.buyBtn')
			...
			.attr('href', origin + '/JW666key/order/' + productId + '?direction=buy&utm_source='+utm_source+'&utm_medium='+utm_medium+'&utm_term='+utm_term+'&utm_campaign='+utm_campaign+'&utm_content='+utm_content+'&openbrowser=false&experience=true')
