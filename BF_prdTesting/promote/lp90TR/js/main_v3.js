...
var technicalAnalysisVue = new Vue({
    ...
    data() {
        return {
            ...
            techAnalyInfo: {},
            rankedImgPath: [
                'promote/lp90TR/images/ranking_icon1.png',
                'promote/lp90TR/images/ranking_icon2.png',
                'promote/lp90TR/images/ranking_icon3.png',
                'promote/lp90TR/images/ranking_icon4.png',
                'promote/lp90TR/images/ranking_icon5.png'
            ],
            rankedButtonPath: 'promote/lp90TR/images/r_btn.png',
        ...
        wsResponseHandling(res) {
            ...
            try {
                if (res.data.indexOf('p(') == 0) { //ProductSubscription
                    ...
                    // 盈利公式
                    target.profit = 100 * (target.high - target.low) / (parseFloat(target.current) * target.delta);
