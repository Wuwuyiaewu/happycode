(function() {
    ...
    var sellPrice = ''
    var ws = new WS({
        url: 'wss://testapi.ixmiddle.com/i/websocket',
        heartData: {
    ...
    function mountedData() {
        ...
        $('.sellBtn')
            ...
            .attr('href', origin + '/' + productId + '?direction=sell&utm_source=se2&openbrowser=true&experience=true')
        ...
        $('.buyBtn')
            ...
            .attr('href', origin + '/' + productId + '?direction=buy&utm_source=se2&openbrowser=true&experience=true')
