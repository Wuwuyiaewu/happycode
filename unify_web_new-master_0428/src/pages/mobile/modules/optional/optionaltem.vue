    ...
    <div v-if='product.code_id' class='productItem'>
        <div class='cell'>
            <div class='th' @click='toDetail(product)'>
                ...
                <p class='short_name' v-html='formatProductCode(product)'></p>
            ...
            <div class='ft actionBox'>
                <div class='btn-wrap'>
                    <button
                        v-prophet="['trackEvent', '自选', '行情报价', '行情_卖出', 52]"
                        class='btn'
                    ...
                    <button
                        v-prophet="['trackEvent', '自选', '行情报价', '行情_买入', 51]"
                        class='btn'
    ...
    methods: {
        ...
        toDetail (data) {
            if (window.isPC) {
                ...
                return this.UPDATE_PRODUCT_ACTIVATED_ID(data.code_id)
            }
