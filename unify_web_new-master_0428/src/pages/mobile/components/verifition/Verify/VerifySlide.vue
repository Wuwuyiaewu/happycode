                ...
                if (this.status && this.isEnd == false) {
                    ...
                    reqCheck(data).then(res=>{
                        if (res.repCode == "0000") {
                            ...
                            this.passFlag = true
                            this.tipWords = `${((this.endMovetime-this.startMoveTime)/1000).toFixed(2)}s ${this.$t('verify.successfully')}`
                            ...
                            this.tipWords = this.$t('verify.failed')
                            setTimeout(()=>{
                                    this.tipWords = ""
                            },1000)
                        }
