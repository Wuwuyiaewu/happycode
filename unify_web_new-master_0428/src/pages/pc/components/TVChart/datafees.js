...
var datafeeds = (function () {
    ...
    datafeeds.prototype.resolveSymbol = function resolveSymbol (
        symbolName,
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (_this2.self.getSymbol) {
                symbolInfo = Object.assign(
                    _this2.defaultSymbol(),
                    _this2.self.getSymbol()
                )
            }
            resolve(symbolInfo)
        })
    ...
    datafeeds.prototype.getBars = function getBars (
        symbolInfo,
        resolution,
        rangeStartDate,
        rangeEndDate,
    ...
    datafeeds.prototype.subscribeBars = function subscribeBars (
        symbolInfo,
        resolution,
        onRealtimeCallback,
        subscriberUID,
    ...
    datafeeds.prototype.unsubscribeBars = function unsubscribeBars (
        subscriberUID
    ) {
