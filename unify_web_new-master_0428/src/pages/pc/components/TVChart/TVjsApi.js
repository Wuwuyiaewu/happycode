...
let count = 0
function TVjsApi (socket) {
    // var urls = 'ws://192.168.75.62:9010/websocket/?module=uat-socket&method=/ws&rpcType=websocket'
    this.widgets = null
    // this.socket = new socket(urls)
    // this.datafeeds = new datafeeds(this)
    ;(this.symbol = null), (this.interval = null), (this.cacheData = {}), (this.lastTime = null), (this.getBarTimer = null), (this.isLoading = true)
    var that = this
...
TVjsApi.prototype.init = function (config) {
    ...
    if (!this.widgets) {
        ...
        this.widgets = window.tvWidget = new widget(config || defaultConfig)
        this.symbol = symbol
