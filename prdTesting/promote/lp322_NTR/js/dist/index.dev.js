...
(function () {
  ...
  function mountedData() {
    ...
    }).attr('href', origin + '/yz352001/order/' + productId + '?direction=sell&utm_source=' + utm_source + '&openbrowser=true&experience=true').find('.sellPrice').text(sellPrice ? (sellPrice * 1).toFixed(digits) : '- -');
    $('.buyBtn').css({
      background: buyColor
    }).attr('href', origin + '/yz352001/order/' + productId + '?direction=sell&utm_source=' + utm_source + '&openbrowser=true&experience=true').find('.buyPrice').text(buyPrice ? (buyPrice * 1).toFixed(digits) : '- -');
  }
})();