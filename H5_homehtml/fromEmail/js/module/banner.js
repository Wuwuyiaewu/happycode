define(function(require, exports, module) {
    ...
    var bindEvt = function() {
        if (data.type == 'scrollImage') {
            ...
            parentElement.find(".m-banner_item").each(function(i ,e){
                (function(n){
                    e.addEventListener('click', function(){
                        window._paq && window._paq.push(['trackEvent', '首页', 'banner', 'banner' + n, 76])
                    })
                })(i+1)
            })
            ...
            parentElement.find(".m-banner_item").each(function(i ,e){
                (function(n){
                    e.addEventListener('click', function(){
                        window._paq && window._paq.push(['trackEvent', '首页', '热门活动', '活动' + n, 80])
                    })
                })(i+1)
            })
